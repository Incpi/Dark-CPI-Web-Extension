sap.ui.define([], function () {
  ...
  return {
    ...
    data_updates: {
      bugFixes: [
        { description: "Resolved CSS issues preventing the scrollable section in the configuration window from functioning correctly." },
        { description: "Fixed overflow and text clipping issues in the trace, logs, and design pages, especially in dark mode, ensuring a seamless user experience." },
      ],
      features: [
        { description: "Introduced a quick message popup feature, similar to the CPI helper popup, for enhanced user communication." },
        { description: "Added an automatic trace activation on expiry in Power Trace for more efficient monitoring." },
        { description: "Inline payload formatting is now available in the trace view for clearer data presentation." },
        { description: "Quick links to the trace page and log monitoring page have been implemented for easier navigation." },
        { description: "Table sorting and filtering are now standard UI features, improving data accessibility and usability." },
      ],
      improvements: [
        { description: "Optimized the extension runtime, significantly reducing load times for better performance." },
        { description: "Reduced the extension size by minimizing dependencies and optimizing external libraries." },
        { description: "Limited style overrides to ensure a more consistent and native user experience." },
      ],
    },
    author: {
