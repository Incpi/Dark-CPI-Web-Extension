...
let paths = [
	"script/component/codeEditor",
	"script/utils/const_new",
	"script/component/ExToast",
	"script/component/formatCode",
	"script/component/model",
	"script/component/RequestQueue",
	"script/feature/autoClose",
	"script/utils/constants",
	"script/utils/timeConvert",
	"script/utils/common",
	"script/utils/apiCall",
	"script/utils/link",
	"script/feature/newPopupEvent",
	"script/feature/eventHandlers",
	"script/feature/powerTraceHandler",
];
let updatedPaths = {};
paths.forEach((path) => {
