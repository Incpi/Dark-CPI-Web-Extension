...
function extrachecks(newTheme) {
  document.querySelectorAll("iframe").forEach((iframe) => {
    document.querySelector("html").setAttribute("data-sap-ui-theme", sap.ui.getCore().getConfiguration().getTheme());
    var iframeDoc = iframe.contentDocument || iframe.contentWindow.document;
    if (iframeDoc.querySelector("html").getAttribute("data-sap-theme") !== sap.ui.getCore().getConfiguration().getTheme())
      if (iframeDoc) {
